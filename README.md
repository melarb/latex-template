...
- `main.pdf`: The PDF version of the main template file.
- `example/`: Directory containing example files.
  - `example-homework.tex`: Example LaTeX file from a real homework assignment.
  - `example-homework.pdf`: PDF version of the example homework assignment.
...
## Example
An example LaTeX file (`example/example-homework.tex`) and its corresponding PDF (`example/example-homework.pdf`) are provided to demonstrate how to use the template with a real homework assignment.
